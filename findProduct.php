                              ...
                              if($results -> rowCount()<=0){
                                 ...
                                 foreach ($results as $row) {
                                    ...
                                    echo '<td>'. $row['ProdUnits'].'</td>';
												if ($row['ProdActive'] == 'YES') echo '<td><span class="label label-success">'.$row['ProdActive'].'</span></td>';
												if ($row['ProdActive'] == 'NO') echo '<td><span class="label label-danger">'.$row['ProdActive'].'</span></td>';
                                    echo '<td>
