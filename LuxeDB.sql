...
(8, 'Maria', 'Herrstand', 'mariaherr@mucho', '123456789', 'Gart street', 35.55, 'NO'),
...
--
ALTER TABLE `ProductsBySales`
MODIFY `IdProductSale` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=29;
--
